...
export default function CalorieTracker() {
  ...
  const handleCalculate = () => {
    ...
    if (goal <= 0 || breakfast < 0 || lunch < 0 || dinner < 0 || snacks < 0) {
...
const styles = {
  ...
  input: { padding: "10px", width: "250px", borderRadius: "8px", border: "1px solid #ccc", fontSize: "16px" },
  button: { padding: "10px 20px", backgroundColor: "#4CAF50", color: "white", border: "none", borderRadius: "8px", cursor: "pointer", fontSize: "16px" },
  resultBox: { marginTop: "30px", padding: "15px", borderRadius: "10px", border: "1px solid #ccc", width: "300px", margin: "20px auto", backgroundColor: "#f9f9f9" },
};
